      ...
      <div class="container">
        <div class="row align-items-stretch retro-layout-2">
          <div class="col-md-4">
            ...
            <a href="{{ route('singlepost', $post->slug) }}" class="h-entry mb-30 v-height gradient" style="background-image: url('{{ $post->image  }}');">
          ...
          <div class="col-md-4">
            <a href="{{ route('singlepost', $post->slug) }}" class="h-entry img-5 h-100 gradient" style="background-image: url('{{ $post->image  }}');">
          ...
          <div class="col-md-4">
            ...
            <a href="s{{ route('singlepost', $post->slug) }}" class="h-entry mb-30 v-height gradient" style="background-image: url('{{ $post->image  }}');">
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 mb-4">
            <div class="entry2">
              <a href="{{ route('singlepost', $post->slug) }}"><img src="{{ $post->image }}" alt="Image" class="img-fluid rounded"></a>
              <div class="excerpt">
              <span class="post-category text-white bg-secondary mb-3">{{ $post->category->name }}</span>

              <h2><a href="{{ route('singlepost', $post->slug) }}">{{ $post->title }}</a></h2>
              <div class="post-meta align-items-center text-left clearfix">
                ...
                <p>{!!strlen($post->description) > 200 ? substr($post->description,0,200) : $post->description!!}</p>
                <p><a href="{{ route('singlepost', $post->slug) }}">Read More</a></p>
              </div>
            </div>
          </div>
          @endforeach
